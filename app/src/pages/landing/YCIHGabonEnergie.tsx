  ...
  return (
    <>
      <style>{`
        ...
        .yge-logo { color:#D4A935; font-family:'Playfair Display',Georgia,serif; font-size:1.05rem; letter-spacing:.06em; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; min-width:0; }
